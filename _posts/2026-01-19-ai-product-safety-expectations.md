---
layout: post
title: Student Voice and the EdTech Product Safety Expectations
author: Tim Davies
category: blog
featured: true
projects:
...
Alongside the Generative AI for Education summit in London yesterday, [the DfE updated their ‘Product Safety Expectations’ for EdTech developers](https://www.gov.uk/government/publications/generative-ai-product-safety-standards/generative-ai-product-safety-standards), and for schools to consider when deciding which tools are safe to use.

Many of the updates reflect discussions from the GenAI in Education: Have Your Say process - offering a powerful mandate from students for these expectations. Check out what students had to say in the video here [https://connectedbydata.org/ai-in-education/](https://connectedbydata.org/ai-in-education/) or the full report. 
...
[**The expectations on manipulation**](https://www.gov.uk/government/publications/generative-ai-product-safety-standards/generative-ai-product-safety-standards#manipulation) calls on tools not to deceive or mislead users, to portray absolute or unjustified confidence, or to use peer-pressure to motivate engagement. Tools should not steer users towards paid options through biased wording or layouts. 
...
**That might require one more future update: [updating the recommendations on design and testing](https://www.gov.uk/government/publications/generative-ai-product-safety-standards/generative-ai-product-safety-standards#design-and-testing)** to strengthen the role of both government and students in making decisions about whether AI for Education tools are ready for use. 
...
(Footnote: Because [gov.uk](http://gov.uk) pages lack a tracked changes, I had to dig out [this archived copy](https://qna.files.parliament.uk/qna-attachments/1764680/original/HL4963%20attachment.pdf) of the standards to fully see what’s changed).