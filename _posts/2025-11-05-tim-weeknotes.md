...
[Jeni has written more about it over on BlueSky here](https://bsky.app/profile/did:plc:mo7wgmn53nbs64qzdzdpupde/post/3m4sxb4pjqh2x). The genesis of this project is both in the [EdTech design lab](https://connectedbydata.org/events/2024-01-10-education-design-lab) we ran back in 2023/24, and in [the design lab workshop we held just before the summer on Supporting Collective School Decision Making on AI and Education Technology](https://connectedbydata.org/events/2025-07-22-design-lab-dfe) . I've captured [a few notes on the resource design process here](/blog/2025/10/31/reflections-on-ai-in-education-workshop-design). 
...
I've been really impressed with [HotCRP](https://hotcrp.com/) so far as our submission and review platform. I had reviews all assigned within an hour - instead of the day of spreadsheet and script-wrangling last year with our home-grown Google Docs solution.  
...
Mostly I'm reading & reviewing abstracts! But I did have chance today to catch-up on [Maas and Inglés' great paper on 'Beyond Participatory AI' published last year](https://ojs.aaai.org/index.php/AIES/article/view/31693) which calls for participatory AI practice to have a much clearer analysis of political economy and power asymmetries between AI developers and other stakeholders. Well worth a read. 
